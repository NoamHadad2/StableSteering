...
Current run count: 18 across 3 prompts.

Current aggregate summary: 36 rounds, 180 candidate images, and 20 candidates flagged by the lightweight visual checks.
